...
import { ArrowLeft, CheckCircle2, FolderPlus, Save, Tag, AtSign, FolderTree, ChevronDown, Search, CornerDownRight } from 'lucide-vue-next'
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <label class="flex flex-col gap-1.5" ref="selectContainerRef">
            ...
            <div class="relative">
              <FolderTree
                class="w-4 h-4 text-gray-400 dark:text-neutral-500 absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none z-10"
              />
