...
async function run() {
  ...
  console.log("Iniciando Puppeteer para inspecionar preços do Buy Box...");
  ...
  console.log("\n=== BUSCANDO PREÇOS DENTRO DE .ui-pdp-container__col--right ===");
  $(".ui-pdp-container__col--right .andes-money-amount").each((i, el) => {
